...
\begin{figure}[h]
\label{rs:rys}
\centerline{\includegraphics[scale=0.65]{uklad-przekaznikowy}}
...
\begin{figure}
\centerline{\includegraphics[scale=0.65]{symbole-bramek}}
...
\begin{figure}[ht]
\begin{center}
{\includegraphics[scale=0.33]{uklad1}}
{\includegraphics[scale=0.33]{uklad2}}
{\includegraphics[scale=0.33]{uklad3}}
